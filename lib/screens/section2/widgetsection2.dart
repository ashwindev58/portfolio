  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          AboutMeTittle(constraints: constraints),
          SizedBox(
            width: constraints.maxWidth * 0.1,
          ),
          AboutMeDescp(constraints: constraints),
        ],
      ),
    );
  }
...
class AboutMeTittle extends StatelessWidget {
  const AboutMeTittle({
    super.key,
      ...
      children: [
        ...
        SizedBox(
         ...
         "A creative and dedicated\nFlutter developer",
          ...
          style: TextStyle(
            color: Colors.white,
            fontSize: isWeb()? 35:20,
            fontWeight: FontWeight.w900,
          ),
        ),
        SizedBox(height: constraints.maxHeight*0.05,),
        Row(
          mainAxisAlignment:isWeb()? MainAxisAlignment.center:MainAxisAlignment.spaceEvenly,
          children: [
            CircularImageButton(
...
class AboutMeDescp extends StatelessWidget {
  const AboutMeDescp({
    super.key,
    required this.constraints,
  });
